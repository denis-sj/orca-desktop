...
export const CORE_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    usage:
      'orca worktree rm --worktree <selector> [--keep-branch] [--force] [--run-hooks] [--allow-failed-archive-hook] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'worktree',
      'keep-branch',
    ...
    notes: [
      ...
      'Pass --keep-branch to retain the local branch ref after removing the worktree and its checkout.',
      'For Git worktrees, removal attempts to delete the checked-out local branch unless --keep-branch is passed. Orca retains branches it knows predated the worktree and any branch whose changes it cannot prove are already merged.'
    ]
  },
  {
    path: ['worktree', 'ps'],
